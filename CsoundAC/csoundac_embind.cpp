...
EMSCRIPTEN_BINDINGS(csoundac) {  
    ...
    emscripten::class_<csound::Chord>("Chord")
        ...
        .function("eET", &csound::Chord::eET)
        .function("iseET", &csound::Chord::iseET)
        ...
        .function("eOPTT", &csound::Chord::eOPTg)
        .function("eOPTg", &csound::Chord::eOPTg)
        .function("eOPTIg", &csound::Chord::eOPTIg)
        .function("eOPTgI", &csound::Chord::eOPTIg)
        ...
        .function("iseOPTT", &csound::Chord::iseOPTg)
        .function("iseOPTg", &csound::Chord::iseOPTg)
        .function("iseOPTTI", &csound::Chord::iseOPTIg)
        .function("iseOPTIg", &csound::Chord::iseOPTIg)
        ...
        .function("iseRPTT", &csound::Chord::iseRPTg)
        .function("iseRPTg", &csound::Chord::iseRPTg)
        .function("iseRPTTI", &csound::Chord::iseRPTIg)
        .function("iseRPTIg", &csound::Chord::iseRPTIg)
        .function("iset", &csound::Chord::iset)
        .function("iseT", &csound::Chord::iseT)
        .function("iseTT", &csound::Chord::iseTg)
        .function("iseTg", &csound::Chord::iseTg)
    ...
    emscripten::class_<Counterpoint>("Counterpoint")
        .constructor<>()
        .function("ABS", &Counterpoint::ABS_)
        ...
        .function("MAX", &Counterpoint::MAX_)
        //.function("message", &Counterpoint::message)
        .function("MIN", &Counterpoint::MIN_)
